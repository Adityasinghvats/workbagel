            ...
            <View className="flex-1 bg-black/50 justify-center items-center px-6">
                <View className="bg-white rounded-3xl w-full max-w-md overflow-hidden">
                    ...
                    <ScrollView className="px-6 py-6" showsVerticalScrollIndicator={false}>
                        {/* Slot Date */}
                        <View className="mb-5">
                            <Text className="text-md font-semibold text-gray-500 mb-2">Slot Date</Text>
                        ...
                        {/* Duration */}
                        <View className="mb-5">
                            <Text className="text-md font-semibold text-gray-500 mb-2">Duration</Text>
                            <View className="flex-row items-center gap-2 bg-gray-200 rounded-xl px-4 py-3">
                        ...
                        {/* Price */}
                        <View className="mb-5">
                            <Text className="text-md font-semibold text-gray-500 mb-2">Total Price</Text>
                            <View className="flex-row items-center gap-2 bg-gray-200 rounded-xl px-4 py-3">
                        ...
                        <View className="mb-6">
                            ...
                            <TextInput
                                className="bg-gray-200 rounded-xl px-4 py-3 text-base text-gray-900 min-h-[100px]"
